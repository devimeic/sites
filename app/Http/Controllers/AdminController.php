...
class AdminController extends Controller
{
    public function index()
    {
        ...
        return view('admin.dashboard', compact(['tittle','jumlahUser','berkas','lapangan','rekomendasi','datas']));
    }

    public function wa()
    {
        $tittle = 'Whatshap Gateway';
        return view('admin.wa-gateway', compact(['tittle']));
    }
