...
<div class="row">
            ...
            <div class="col-xl-12 col-md-12">
                <div class="card-header d-sm-flex d-block pb-0 border-0">
                    <div class="mr-auto pr-3">
                        <h4 class="text-black font-w600 fs-20">Jumlah User</h4>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <span class="fs-14 mb-2 text-black">Pemohon</span><br>
                                                <span class="title text-black font-w600">{{ $jumlahUser }}</span>
                                            </div>
                                        </div>
                                ...
                                <div class="card avtivity-card">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <span class="fs-14 mb-2 text-black">Verifikator Berkas</span><br>
                                                <span class="title text-black font-w600">{{ $berkas }}</span>
                                            </div>
                                        </div>
                                        <div class="progress" style="height:5px;">
                                ...
                                <div class="card avtivity-card">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <span class="fs-14 mb-2 text-black">Verifikator Lapangan</span><br>
                                                <span class="title text-black font-w600">{{ $lapangan }}</span>
                                            </div>
                                        </div>
                                        <div class="progress" style="height:5px;">
                                ...
                                <div class="card avtivity-card">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <span class="fs-14 mb-2 text-black">Pemberi Rekomendasi</span><br>

                                                <span class="title text-black font-w600">{{ $rekomendasi }}</span>
                                            </div>
                                        </div>
                                        <div class="progress" style="height:5px;">
    ...
    <div class="col-md-6 col-xl-9 col-xxl-8">
        <div class="row">
            <div class="col-xl-12">
                <div class="card plan-list">
                    ...
                    <div class="card-body tab-content pt-2 loadmore-content dz-scroll height750"  id="DietMenusContent">
                        <div class="tab-pane active show fade" id="Unifinshed">
                            ...
                            <div class="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2">
                                <div class="col-xl-5 col-xxl-7 col-lg-6 col-sm-7 d-flex align-items-center">
                                    <div class="list-icon bg-light mr-3 mb-3">
                                        <p class="fs-24 text-black mb-0 mt-1">{{ Carbon::createFromFormat('Y-m-d H:i:s', $item->jadwal)->format('d') }}</p>
                                        <span class="fs-14 text-black">{{ Carbon::createFromFormat('Y-m-d H:i:s', $item->jadwal)->isoFormat('MMMM') }}</span>
                            ...
                            <div class="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2">
                                <div class="info mb-3">
                                    <h4 class="fs-20 mx-3"><a class="text-black">Tidak Ada Jadwal Rapat</a></h4>
                                </div>
                            </div>
                            @endforelse
                    </div>
