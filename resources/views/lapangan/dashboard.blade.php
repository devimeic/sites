                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <span class="fs-14 mb-2 text-black">Verifikasi Lapangan</span><br>
                                                <span class="title text-black font-w600">{{ $verifikasi }}</span>
                                            </div>
                                        </div>
                                ...
                                <div class="card avtivity-card">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <span class="fs-14 mb-2 text-black">Revisi Lapangan</span><br>

                                                <span class="title text-black font-w600">{{ $revisi }}</span>
                                            </div>
                                        </div>
                                        <div class="progress" style="height:5px;">
