                        ...
                        <ul class="navbar-nav header-right">
							<li class="nav-item dropdown notification_dropdown">
                                ...
                                <div class="dropdown-menu rounded dropdown-menu-right">
										...
										<ul class="timeline">
                                            ...
                                            @empty
                                                <li>
                                                    <div class="timeline-panel">
                                                        <div class="media-body">
                                                            <h4 class="mb-1 text-center">Belum Ada Notifikasi</h4>
                                    ...
                                    <a class="all-notification" href="{{ route('alldelete') }}">Hapus Semua Notifikasi <i class="flaticon-381-trash-1"></i></a>
                                </div>
                            </li>
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" style="background-color: rgb(216, 224, 252);">
                                    ...
                                    {{-- <a href="{{ route('logout') }}" class="dropdown-item ai-icon" onclick="event.preventDefault(); logoutWithLoader();
