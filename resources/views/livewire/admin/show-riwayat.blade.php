                ...
                <div class="card-body">
                    <div wire:ignore.self  class="form-wizard order-create">
                        <ul class="nav nav-wizard"  >
                            ...
                            <li><a class="w-100 h-100 rounded-full border-primary btn mx-4{{ $step > 5 ? 'btn-primary bg-primary  text-white mx-4' : '' }} {{  $step == 5 ? 'rounded-fullborder bg-primary text-white mx-4' : '' }}" wire:click.prevent="jump(4)">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea rows="4" id="alamat_dev" name="alamat_dev" class="form-control text-black"  value="{{ $pengajuan->alamat_dev }}" readonly></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="alamat_proyek" name="alamat_proyek" class="form-control text-black"  value="{{ $pengajuan->alamat_pro }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
