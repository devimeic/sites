                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <span class="fs-14 mb-2 text-black">Pengajuan perlu revisi lapangan</span><br>
                                ...
                                <div class="card avtivity-card">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <span class="fs-14 mb-2 text-black">Pengajuan perlu revisi berkas</span><br>
                                ...
                                <div class="card avtivity-card">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <span class="fs-14 mb-2 text-black">Pengajuan Selesai</span><br>
